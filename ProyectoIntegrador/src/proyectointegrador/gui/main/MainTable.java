...
package proyectointegrador.gui.main;

import javax.swing.ListSelectionModel;
import proyectointegrador.gui.complements.modelTableProducto;

public class MainTable extends javax.swing.JFrame {

    modelTableProducto model;
    
    public MainTable() {
        initComponents();
        jTable1.getSelectionModel().setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        model = new modelTableProducto();
        paintTable(model);
    }
    
    private void paintTable(modelTableProducto tableModel) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Table Producto");
